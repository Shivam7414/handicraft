...
<body>
    ...
    <p class="table-title" id="14">Storage Box</p>
    <div class="line"></div><br>
    <p class="table-type">1 Story Boxes</p>
    ...
    <div class="product-container">
        ...
        <div class="container">
            <?php
            $query = "SELECT  * from item where product_id=14";
    ...
    <p class="Bar-Table" id="21">2 Story Boxes</p>
    <hr class="Table-line">
    <div class="product-container table">
        ...
        <div class="container">
            ...
            <?php
            $query = "SELECT  * from item where product_id=21";
            $query_run = mysqli_query($conn, $query);
            $fetch_data = mysqli_num_rows($query_run) > 0;
            if ($fetch_data) {
                while ($row = mysqli_fetch_assoc($query_run)) {
    ...
    <p class="Bar-Table">3 Story Boxes</p>
    <hr class="Table-line">
    <div class="product-container  table">

        <div class="container" id="22">
            <?php
            $query = "SELECT  * from item where product_id=22";
            $query_run = mysqli_query($conn, $query);
            $fetch_data = mysqli_num_rows($query_run) > 0;
            if ($fetch_data) {
                while ($row = mysqli_fetch_assoc($query_run)) {
