...
<body>
    ...
    <p class="table-title" id="7">Other Articles</p>
    <div class="line"></div><br>
    <p class="table-type">Shoe Racks</p>
    ...
    <div class="product-container">
        ...
        <div class="container">
            <?php
            $query = "SELECT  * from item where product_id=7";
    ...
    <p class="Bar-Table" id="8">Side Board With Glass Or With Wood</p>
    <hr class="Table-line">
    <div class="product-container table">
        ...
        <div class="container">
            ...
            <?php
            $query = "SELECT  * from item where product_id=8";
            $query_run = mysqli_query($conn, $query);
            $fetch_data = mysqli_num_rows($query_run) > 0;
            if ($fetch_data) {
                while ($row = mysqli_fetch_assoc($query_run)) {
