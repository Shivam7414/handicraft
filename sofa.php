...
<body>
    ...
    <p class="table-title" id="13">Sofa</p>
    <div class="line"></div><br>
    <p class="table-type">1 Seater Sofa</p>
    ...
    <div class="product-container">
        ...
        <div class="container">
            <?php
            $query = "SELECT  * from item where product_id=13";
    ...
    <p class="Bar-Table" id="17">2 Seater Sofa</p>
    <hr class="Table-line">
    <div class="product-container table">
        ...
        <div class="container">
            ...
            <?php
            $query = "SELECT  * from item where product_id=17";
            $query_run = mysqli_query($conn, $query);
            $fetch_data = mysqli_num_rows($query_run) > 0;
            if ($fetch_data) {
                while ($row = mysqli_fetch_assoc($query_run)) {
    ...
    <p class="Bar-Table">3 Seater Sofa</p>
    <hr class="Table-line">
    <div class="product-container  table">

        <div class="container" id="19">
            <?php
            $query = "SELECT  * from item where product_id=19";
            $query_run = mysqli_query($conn, $query);
            $fetch_data = mysqli_num_rows($query_run) > 0;
            if ($fetch_data) {
                while ($row = mysqli_fetch_assoc($query_run)) {
